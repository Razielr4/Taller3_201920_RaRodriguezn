...
*  @author Kevin Wayne
*/
public class SeparateChainingHashST<Key extends Comparable<Key>, Value> implements IHashST<Key, Value> {
   ...
   //metodos y atributos extra
   private int numeroRehash;
   public int getN(){
   	return n;
   }
   public int getM(){
   ...
   public void put(Key key, Value val) {
       ...
       //TODO rehash con mas de 5 elementos :3
       // double table size if average length of list >= 10
       if (n > 5*m) resize(2*m+1);
